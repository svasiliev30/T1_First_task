...
@EnableKafka
@Configuration
public class KafkaConfConsumerTransaction extends KafkaConfig {
    @Bean
    public ConsumerFactory<String, Transaction> consumerFactoryTransaction() {
        ...
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE,
                "org.example.dao.entity.Transaction");
    ...
    kafkaListenerContainerFactoryTransaction() {
