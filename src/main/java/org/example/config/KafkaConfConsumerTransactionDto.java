...
@EnableKafka
@Configuration
public class KafkaConfConsumerTransactionDto extends KafkaConfig {
    @Bean
    public ConsumerFactory<String, TransactionDto> consumerFactoryTransactionDto() {
        ...
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE,
                "org.example.dao.dto.TransactionDto");
    ...
    kafkaListenerContainerFactoryTransactionDto() {

        ConcurrentKafkaListenerContainerFactory<String, TransactionDto> factory =
                new ConcurrentKafkaListenerContainerFactory<>();
        factory.setConsumerFactory(consumerFactoryTransactionDto());
